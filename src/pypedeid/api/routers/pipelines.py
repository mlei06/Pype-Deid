...
from pypedeid.pipeline_store import (
    delete_pipeline,
    list_pipelines,
...
from pypedeid.pipes.regex_ner import builtin_regex_label_names
...
def _inject_base_labels(
    ...
    from pypedeid.pipes.regex_ner import BUILTIN_REGEX_PATTERNS

...
from pypedeid.eval.matching import (
    EvalMetrics,
    LabelMetrics,
    MacroMetrics,
    MatchResult,
...
from pypedeid.eval.redaction import LabelLeakage, RedactionMetrics, compute_redaction_metrics
from pypedeid.pipes.base import Pipe
from pypedeid.risk import RiskProfile, default_risk_profile
...
def evaluate_pipeline(
    ...
    *pred_label_remap*, when set, renames **predicted** span labels right after
    ...
    is :func:`~pypedeid.risk.default_risk_profile` (``PYPEDEID_RISK_PROFILE_NAME``,

...
:class:`~pypedeid.domain.EntitySpan` objects with exact offsets.
...
Requires ``pip install pypedeid[llm]``.
"""
...
class LlmNerPipe(ConfigurablePipe):
    ...
    def _get_client(self) -> Any:
        ...
        from pypedeid.config import get_settings
        from pypedeid.synthesis.client import OpenAIResponsesClient
